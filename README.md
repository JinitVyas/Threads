Threads -  A WebApp created in Larvel with features like Authentication, PostThread, SearchThread, ViewProfile, Follow/Unfollow, EditProfile, MyThreads, ShowAllThreads, with an attractive UI.
